...
import { addGejala } from "../../../config/Redux/Action";

export default function ModalAddGejala() {
  const { isUpdate, gejalas } = useSelector((state) => state.globalReducer);
  ...
  const handleSubmit = async (values) => {
    try {
      ...
      await addGejala(transformedValues);
