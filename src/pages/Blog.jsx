...
export default function Blog() {
  ...
  return (
    <div className="w-full h-full flex flex-col">
      ...
      <div className="w-full h-full flex flex-col gap-10 xl:gap-2">
        {blogs?.map((blog) => (
          <div
            key={blog.id}
            className="w-full h-full flex flex-col xl:flex-row gap-2 shadow-lg p-2"
          >
            <img
            ...
            <div className="w-full xl:w-2/4 flex flex-col">
              <h3 className="font-semibold text-lg xl:text-2xl">{blog.title}</h3>
            </div>
